...
INSERT INTO `room` VALUES (175, 'f4999250-0828-11e9-8b7c-f90e6ffd643f', 2, '慈宁宫', '8011', '4b53d400-121c-11e9-9989-d75a6f62cec3', '欢乐唱响', '1_2', 1545746053903, 1547376744683, 0, 1);
INSERT INTO `room` VALUES (176, 'f4999250-0828-11e9-8b7c-f90e6ffd643f', 2, '慈宁宫', '8011', '94902cb0-1224-11e9-9989-d75a6f62cec3', '欢乐唱响', '1_2', 1545746053903, 1547376744683, 0, 1);
INSERT INTO `room` VALUES (177, 'f4999250-0828-11e9-8b7c-f90e6ffd643f', 2, '慈宁宫', '8011', 'f0664fa0-1720-11e9-b5e7-cd0a8c11a7bb', '欢乐唱响', '1_2', 1545746053903, 1547376744683, 0, 1);
INSERT INTO `room` VALUES (178, 'f4999250-0828-11e9-8b7c-f90e6ffd643f', 2, '慈宁宫', '8011', 'dae7fde0-1720-11e9-b5e7-cd0a8c11a7bb', '欢乐唱响', '1_2', 1545746053903, 1547376744683, 0, 1);
...
CREATE TABLE `roomorder`  (
  ...
  `stockGoods` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '使用寄存中的商品',
  `stockQty` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `depositGoods` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '寄存商品',
  `depositQty` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `roomorder` VALUES (3, '031547552547375', '6666', 1, '1e7e14a0-1225-11e9-9989-d75a6f62cec3', 1, '3', '', '', '', '', '', '', 1547552547012, 1547552553096, NULL, 298.00, NULL, 3, '收银员1', NULL, 1547552547375, 1);
INSERT INTO `roomorder` VALUES (4, '491547552687483', '8011', 0, '94902cb0-1224-11e9-9989-d75a6f62cec3', 1, '2', '', '', NULL, NULL, NULL, NULL, 1547552687170, NULL, NULL, NULL, NULL, NULL, '收银员1', NULL, 1547552687483, 0);
...
-- Records of vip
-- ----------------------------
INSERT INTO `vip` VALUES (1, '15920055057', 0.00, NULL, NULL, NULL, NULL, 1547546009313, 1, 0, 0);
...
CREATE TABLE `vipstock`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nun` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '订单编码',
  `vip` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `goods` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `qty` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `off` int(11) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
